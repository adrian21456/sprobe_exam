...
abstract class ModEmployeeFileController extends Controller
{
    ...
    public function __construct(){
        parent::__construct();
        $this->model = new \App\Models\EmployeeFile();
        $this->crudService = new CRUDService($this->model);
    }

    // GET /api/employee_file
    ...
    // PUT/PATCH /api/employee_file/{id}
